...
- **Repository path:** `docs/features/feat-redesign-task-card/README.md`
...
3. If you want, I can create focused widget-level docs & add example screenshots or assets to `docs/features/feat-redesign-task-card/assets/`.
